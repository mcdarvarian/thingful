...
const ThingsService = {
  ...
  serializeThing(thing) {
    ...
    let utc = new Date(thingData.date_created.getTime() - thingData.date_created.getTimezoneOffset() * 60000)
  ...
  serializeThingReview(review) {
    ...
    let utc = new Date(reviewData.date_created.getTime() - reviewData.date_created.getTimezoneOffset() * 60000)
    return {
      id: reviewData.id,
